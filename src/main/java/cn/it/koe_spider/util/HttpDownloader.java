...
public class HttpDownloader {
    ...
    public static void main(String[] args) throws IOException {
        String url = "http://down-www.7down.net/pcdown/soft/N/neodownloaderbuild.rar";
        new HttpDownloader(url, "D:/neodownloaderbuild.rar", 5, 5000).get();
    }
